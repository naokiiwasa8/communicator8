...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference("Community.count") do
      post communities_url, params: { community: { community_name: @community.community_name } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { community_name: @community.community_name } }
